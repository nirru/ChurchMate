...
public class MenuAndNotification extends FragmentActivity {
	...
	private void init() {
		sharedPreferences = MenuAndNotification.this.getSharedPreferences("com.example.app",
				MenuAndNotification.MODE_PRIVATE);
		
		notificationID = sharedPreferences.getInt(AppConstant.NOTIFICATION_PUSH_NOTIFICATION_ID, 0);
		...
		clientId = sharedPreferences.getInt(
				AppConstant.PREFS_KEYS_CLIENT_ID, 0);
