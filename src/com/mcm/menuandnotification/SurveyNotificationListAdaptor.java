...
public class SurveyNotificationListAdaptor extends BaseAdapter {
	...
	public SurveyNotificationListAdaptor(Context context,
			...
			String folderName, int clientID, int memberId, int notificationId, RelativeLayout rel_xyz) {
	...
	private void displayView(int id, boolean isTrue) {
		...
		ProgressDialog mProgressDialog = new ProgressDialog(context);
	       new SurveyAsync(context, mProgressDialog, url, clientID, memberId, notificationId, isTrue, rel_xyz).execute("");
