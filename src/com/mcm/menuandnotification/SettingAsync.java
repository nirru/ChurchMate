...
public class SettingAsync extends AsyncTask<String, String, String> {
	...
	String message, url, login_member_first_name, login_member_sur_name,
			...
			login_member_mobile_number, login_member_email, login_member_password, login_member_homeTelephone;
	...
	public SettingAsync(Context context, String url,
			...
			String login_member_mobile_number, String login_member_email, String login_member_password,  String monthOFCalender, String folderName,String login_member_homeTelephone) {
		...
		this.login_member_homeTelephone = login_member_homeTelephone;
		Log.e("MONTH OF CALENDER", "" + url);
	}
...
//				((Activity) context).finish();
	...
	void showDialog() {
		mProgressDialog
				.setMessage("Saving Settings, please wait..");
