...
public class SettingSavedMemberDetail {
	...
	String message, url, login_member_first_name, login_member_sur_name,
			...
			login_member_password, monthOFCalender, login_member_homeTelephone;
	...
	public SettingSavedMemberDetail(String url, int memberID, int clientID,
			...
			String login_member_password,String monthOFCalender, String login_member_homeTelephone) {
		...
		Log.e("URL FOR SAVING MEMBER SETTING", "" + url);
...
//		Log.e("SETTING_PASSWORD", "" + login_member_password);
		Log.e("MEMBER DATE OF BIRTH", "" + login_member_number_of_children);
	}
	...
	public String postDataToServer() {
		...
		try {
			...
			jsonObject.accumulate(AppConstant.SETTING_HOME_TELEPHONE,
					login_member_homeTelephone);
			jsonObject.accumulate(AppConstant.SETTING_CHILDREN,
