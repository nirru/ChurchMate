...
public class MCMDatabase {
	...
	public void notificationreminderTable(SQLiteDatabase database) {
		SplashActivity.databaseHelper
				.createTable(database, " CREATE TABLE IF NOT EXISTS "
						+ AppConstant.CHECK_NOTIFICATION_REMINDER_TABLE + " ("
						+ AppConstant.NOTIFICATIION_REMIONDER_CLIENT_ID + " Integer, "
						+ AppConstant.NOTIFICATIION_REMIONDER_NAME + " Text,"
						+ AppConstant.NOTIFICATIION_REMIONDER_CLIENT_EMAIL + " Text,"
						+ AppConstant.NOTIFICATIION_REMIONDER_ID + " Long,"
						+ AppConstant.NOTIFICATIION_REMIONDER_IS_SET + " boolean" + " );");
	}
	...
	public void createdatabase() {
		if (SplashActivity.databaseHelper.isDatabaseExists(context
			...
			notificationreminderTable(database);
		}
	}
