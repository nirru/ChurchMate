...
public class AppConstant {
	...
	public static final String CHECK_NOTIFICATION_REMINDER_TABLE = "check_notification_reminder_table";
	...
	/*---------------------------------------CHECK NOTIFICATION REMINDER Database Constant---------------------------------------------------*/
	public static String NOTIFICATIION_REMIONDER_CLIENT_ID = "reminder_client_ID";
	public static String NOTIFICATIION_REMIONDER_CLIENT_EMAIL = "reminder_client_EMAIL";
	public static String NOTIFICATIION_REMIONDER_NAME = "reminder_name";
	public static String NOTIFICATIION_REMIONDER_IS_SET = "is_reminder_set";
	public static String NOTIFICATIION_REMIONDER_ID = "reminder_id";
