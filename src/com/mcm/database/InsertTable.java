...
//		Log.e("TAG MEMBER CLIENT ID", " " + clientID);
	...
	public void insertValueInNotificationRemindertable(int clientID,
			String event_name, String clientEmail,long reminderID, boolean isSet) {

		Log.e("TAG MEMBER CLIENT ID", " " + clientID);
		ContentValues contentValue = new ContentValues();
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_CLIENT_ID, clientID);
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_NAME, event_name);
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_CLIENT_EMAIL, clientEmail);
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_ID,  reminderID);
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_IS_SET,  isSet);
		try {
			// String whereClause = AppConstant.MCM_MEMBER_PASSWORD + "= " +
			// passWordString;
			SplashActivity.databaseHelper.insertInToTable(database,
					AppConstant.CHECK_NOTIFICATION_REMINDER_TABLE, contentValue);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}
	...
	public void updateValueInNotificationRemindertable(int clientID,
			String event_name, String clientEmail,long reminderID, boolean isSet) {
		...
		contentValue.put(AppConstant.NOTIFICATIION_REMIONDER_IS_SET,  isSet);
		try {
			 String whereClause = AppConstant.NOTIFICATIION_REMIONDER_NAME + "='" +
					 event_name + "'";
			SplashActivity.databaseHelper.updateTableItem(database,
					AppConstant.CHECK_NOTIFICATION_REMINDER_TABLE, contentValue, whereClause);
		} catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
		}
