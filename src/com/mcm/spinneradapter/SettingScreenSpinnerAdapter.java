...
public class SettingScreenSpinnerAdapter extends BaseAdapter {
	...
	public SettingScreenSpinnerAdapter(Context context,
			ArrayList<ArrayList<String>> values, String defaultSpinnerValue,
			String id) {
		...
		Log.e("defaultSpinnerValueL IDDDD", "  " + id);
	}
	...
	public View getView(int pos, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = mInflator.inflate(R.layout.custom_spinner_row,
					parent, false);
		}
		...
		// }
		// Log.e("VALUE OF ID LOKKING FOR", "" + id);
		if (id.trim() == "null") {
			text2.setText(defaultSpinnerValue);
		} else {
